...
function upgrade_module_2_10_0($module)
{
    ...
    return $manager->migrate(
        ...
        static function () use ($module): bool {
            (new LegacyCleanupService($module))->cleanup();

            // Register only hooks that exist in the installed PrestaShop core. Direct
            // SELECT queries avoid helper methods that may append hidden LIMIT clauses.
